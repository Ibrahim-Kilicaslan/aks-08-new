...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/oktest/capstone/username')
    password_param = ssm.get_parameter(Name="/oktest/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds-test.cbanmzptkrzf.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesoktestblog' # please enter your s3 bucket name
