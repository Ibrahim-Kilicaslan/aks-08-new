...
cd /home/ubuntu/
TOKEN=$(aws --region=us-east-1 ssm get-parameter --name /oktest/capstone/token --with-decryption --query 'Parameter.Value' --output text)
git clone https://$TOKEN@github.com/okti3535/capstone-test-08.git
cd /home/ubuntu/capstone-test-08
apt-get install python3.10-dev default-libmysqlclient-dev -y
pip3 install -r requirements.txt
cd /home/ubuntu/capstone-test-08/src
