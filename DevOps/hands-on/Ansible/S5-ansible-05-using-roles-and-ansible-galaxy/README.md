...
```bash
ansible-galaxy init apache --init-path /home/ec2-user/ansible/roles/
```
...
* First create a new EC2 instance with Ubuntu 24.04 instance image. AMI Number: ami-04b70fa74e45c3917
